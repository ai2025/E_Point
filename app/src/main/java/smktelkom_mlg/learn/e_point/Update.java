...
public class Update extends AppCompatActivity {
    ...
    String updateUrl = "http://10.0.2.2/epoin/updateData.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            SimpleAdapter sAdap;
            sAdap = new SimpleAdapter(Update.this, MyArrList, R.layout.activity_show,
        ...
        try {
            ...
            sAdapt = new SimpleAdapter(Update.this, MyArrList2, R.layout.activity_show2,
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final ProgressDialog progressDialog = ProgressDialog.show(Update.this, "", "Menyimpan....");
